...
class _DashBoardState extends State<DashBoard>{
  ...
  Future getCurrentPosition() async{
    ...
    currentPosition = await geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.best).then((Position position) {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text(currentAddress.toString(), style: TextStyle(
//                        fontSize: 25,
                          color: Colors.white,
                          fontFamily: 'Lemonanda',
                          fontWeight: FontWeight.bold,
            ...
            Container(
              child: Column(
                children: [
                  Text("News Feeds", style: TextStyle(
                    fontSize: 25,
                    color: Colors.black,
                    fontFamily: 'Lemonanda',
                    fontWeight: FontWeight.bold,
            ...
            Container(
              child: Column(
                children: [
                  Text("Our Services and Offers",  style: TextStyle(
                    fontSize: 25,
                    color: Colors.black,
                    fontFamily: 'Lemonanda',
                    fontWeight: FontWeight.bold,
